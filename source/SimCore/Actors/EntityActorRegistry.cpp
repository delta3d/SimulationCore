...
namespace SimCore
{
   namespace Actors
   {
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::PLATFORM_ACTOR_TYPE(new dtDAL::ActorType("Platform", "Entity", "Represents a entity in the game world"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::HUMAN_ACTOR_TYPE(new dtDAL::ActorType("Human", "Entity", "Represents a Human"));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::PLATFORM_WITH_PHYSICS_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::PLATFORM_SWITCHABLE_PHYSICS_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::GROUND_PLATFORM_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::AIR_PLATFORM_ACTOR_TYPE(
               new dtDAL::ActorType("Platform", "Entity.Air.Civilian", "A air vehicle platform",
                        EntityActorRegistry::PLATFORM_SWITCHABLE_PHYSICS_ACTOR_TYPE.get()));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::HELO_PLATFORM_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::MILITARY_GROUND_PLATFORM_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::MILITARY_AIR_PLATFORM_ACTOR_TYPE(
               new dtDAL::ActorType("Platform", "Entity.Air.Military", "A military air platform",
                        EntityActorRegistry::AIR_PLATFORM_ACTOR_TYPE.get()));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::MILITARY_HELO_PLATFORM_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::STEALTH_ACTOR_TYPE(
               new dtDAL::ActorType("Stealth Actor", "Stealth Actor", "This actor is a stealth actor",
                        EntityActorRegistry::PLATFORM_ACTOR_TYPE.get()));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::PLAYER_ACTOR_TYPE(
               new dtDAL::ActorType("Player Actor", "Player Actor", "This actor represents a player",
                        EntityActorRegistry::STEALTH_ACTOR_TYPE.get()));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::DETONATION_ACTOR_TYPE(new dtDAL::ActorType("Detonation Actor", "Effects", "This actor represents a detonation"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::MULTIPLE_DETONATION_ACTOR_TYPE(new dtDAL::ActorType("Multiple Detonation Actor", "Effects", "This actor is used to represent multiple detonations."));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::POSITION_MARKER_ACTOR_TYPE(new dtDAL::ActorType("Position Marker", "Entity", "This represents a position report or a blip."));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::TERRAIN_ACTOR_TYPE(new dtDAL::ActorType("Terrain", "DVTETerrain", "This actor is the terrain used in DVTE."));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::INTERIOR_ACTOR_TYPE(new dtDAL::ActorType("Interior", "Vehicles", "This is an actor for generic vehicle interiors"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::MISSILE_ACTOR_TYPE(new dtDAL::ActorType("Missile", "Munitions", "This is a generic actor for many possible missile-like objects"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::TEXTURE_PROJECTION_ACTOR_TYPE(new dtDAL::ActorType("TextureProjector", "Effects", "This actor represents an image projected onto a model"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::ENVIRONMENT_ACTOR_TYPE(new dtDAL::ActorType("Environment", "IG.Environment", "An extended environment actor based on dtActors::BasicEnvironmentActor"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::DAYTIME_ACTOR_TYPE(new dtDAL::ActorType("DayTime", "Environment", "This is a generic actor for capturing time of day information"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::UNIFORM_ATMOSPHERE_ACTOR_TYPE(new dtDAL::ActorType("UniformAtmosphere", "Environment", "This is a generic actor for many possible missile-like objects"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::MATERIAL_ACTOR_TYPE(new dtDAL::ActorType("ViewerMaterialActor", "Environment", "Holds onto material properties, multiple materials can reference this."));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::MUNITION_TYPE_ACTOR_TYPE(new dtDAL::ActorType(
         "MunitionTypeActor", "Munitions",
         "Contains the name, DIS ID, and an effects info reference specific to a munition."));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::MUNITION_EFFECTS_INFO_ACTOR_TYPE(new dtDAL::ActorType(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::WEAPON_ACTOR_TYPE(new dtDAL::ActorType("WeaponActor", "Munitions", "The actor type that fires a munition."));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::WEAPON_FLASH_ACTOR_TYPE(new dtDAL::ActorType("WeaponFlashActor", "Munitions", "The actor that represents a weapon's flash effect."));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::FLARE_ACTOR_TYPE(new dtDAL::ActorType("FlareActor", "Munitions", "The actor that represents a flare (illumination round)."));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::CONTROL_STATE_ACTOR_TYPE(new dtDAL::ActorType("ControlState", "ControlState", "The base control state actor."));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::BASE_WATER_ACTOR_TYPE(new dtDAL::ActorType("BaseWaterActor", "SimCore.Actors", "The base class for water actors."));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::AGEIA_PARTICLE_SYSTEM_TYPE(new dtDAL::ActorType("NxAgeiaParticleSystemActor", "NxAgeiaPhysicsModels"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::AGEIA_MUNITIONS_PARTICLE_SYSTEM_TYPE(new dtDAL::ActorType("NxAgeiaMunitionsPSysActor", "NxAgeiaPhysicsModels"));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::PHYSICS_PARTICLE_SYSTEM_TYPE(new dtDAL::ActorType("PhysicsParticleSystem", "Effects"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::PHYSICS_MUNITIONS_PARTICLE_SYSTEM_TYPE(new dtDAL::ActorType("MunitionParticles", "Effects"));

      // needs to be implemented whether or not physics is on.
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::PAGED_TERRAIN_PHYSICS_ACTOR_TYPE(new dtDAL::ActorType("PagedTerrainPhysicsActor", "Terrain"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::AGEIA_VEHICLE_ACTOR_TYPE(new dtDAL::ActorType("NxAgeiaFourWheelVehicle", "NxAgeiaPhysicsModels", "",
               EntityActorRegistry::PLATFORM_ACTOR_TYPE.get()));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::FOUR_WHEEL_VEHICLE_ACTOR_TYPE(new dtDAL::ActorType("FourWheelVehicle", "Entity", "",
               EntityActorRegistry::MILITARY_GROUND_PLATFORM_ACTOR_TYPE.get()));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::FOUR_WHEEL_VEHICLE_MIL_ACTOR_TYPE(new dtDAL::ActorType("FourWheelVehicle", "Entity.Ground.Military", "Multi-wheeled vehicle with physics configured for a military vehicle with camo and weopons",
               EntityActorRegistry::MILITARY_GROUND_PLATFORM_ACTOR_TYPE.get()));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::FOUR_WHEEL_VEHICLE_CIV_ACTOR_TYPE(new dtDAL::ActorType("FourWheelVehicle", "Entity.Ground.Civilian", "Multi-wheeled vehicle with physics configured more simply than a military vehicle.",
               EntityActorRegistry::GROUND_PLATFORM_ACTOR_TYPE.get()));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::HUMAN_PHYSICS_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::WARFIGHTER_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::PORTAL_ACTOR_TYPE(new dtDAL::ActorType("Portal", "PortalModels"));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::VEHICLE_CONFIG_ACTOR_TYPE(new dtDAL::ActorType("VehicleConfigActorType", "ViSiTToolkit"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::LM_OPENFLIGHT_TERRAIN_ACTORTYPE(new dtDAL::ActorType("LM_OpenFlightTerrain", "DVTETerrain"));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::DYNAMIC_LIGHT_PROTOTYPE_ACTOR_TYPE(new dtDAL::ActorType("DynamicLightPrototypeActorType", "Effects"));
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::SPOT_LIGHT_PROTOTYPE_ACTOR_TYPE(new dtDAL::ActorType("SpotLightPrototypeActorType", "Effects"));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::BLIP_ACTOR_TYPE(
               new dtDAL::ActorType("Blip", "Entity", ""));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::OLD_REMOTE_PHYSX_ACTOR_TYPE(
               new dtDAL::ActorType("NxAgeiaRemoteKinematicActor", "NxAgeiaPhysicsModels", "",
                        EntityActorRegistry::PLATFORM_ACTOR_TYPE.get()));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::AGEIA_TLAND_ACTOR_TYPE(new dtDAL::ActorType("NxAgeiaTerraPageLandActor", "NxAgeiaPhysicsModels"));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::LAT_LONG_DATA_ACTOR_TYPE
         = new dtDAL::ActorType("LatLongDataActor","SimCore",
         "Actor for capturing remote environmental data.",nullptr);

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::OCEAN_DATA_ACTOR_TYPE
         = new dtDAL::ActorType("OceanDataActor","SimCore",
         "Actor for capturing remote environmental data.", LAT_LONG_DATA_ACTOR_TYPE.get());

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::SURFACE_HAZE_DATA_ACTOR_TYPE
         = new dtDAL::ActorType("SurfaceHazeDataActor","SimCore",
         "Actor for capturing remote environmental data.", LAT_LONG_DATA_ACTOR_TYPE.get());

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::WATER_GRID_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::DR_GHOST_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::SURFACE_VESSEL_ACTOR_TYPE(
         new dtDAL::ActorType("SurfaceVesselActor", "SimCore", "This is the actor used for any type of water vehicle.",
         EntityActorRegistry::PLATFORM_ACTOR_TYPE.get()));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::SOUND_ACTOR_TYPE(
               new dtDAL::ActorType("SoundActor", "SimCore", "A sound actor that only takes up a source when it's not playing."));

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::DYNAMIC_PARTICLE_SYSTEM_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::LOGIC_CONDITIONAL_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::LOGIC_ON_EVENT_ACTOR_TYPE(
      ...
      // Config Actors
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::CAMO_CONFIG_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::ENVIRONMENT_PROCESS_ACTOR_TYPE(
               new dtDAL::ActorType("EnvironmentProcess", "SimCore", "Represents an environmental process such as smoke plumes, clouds, mist, etc.")
               );

      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::ENVIRONMENT_PROCESS_MOVING_SHAPE_ACTOR_TYPE(
      ...
      std::shared_ptr<dtDAL::ActorType> EntityActorRegistry::BATTLEFIELD_GRAPHICS_ACTOR_TYPE( new dtDAL::ActorType("BattlefieldGraphics", "SimCore", "Represents a shape or area that is extruded in 2D."));
