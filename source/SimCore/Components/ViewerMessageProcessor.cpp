   ...
   namespace Components
   {
      ...
      void ViewerMessageProcessor::ProcessMessage(const dtGame::Message& msg)
      {
         ...
         if (msg.GetMessageType() == dtGame::MessageType::INFO_MAP_LOADED)
         {
            ...
            // SET THE TERRAIN
            dtDAL::BaseActorObject* terrainAO = nullptr;
      ...
      ///////////////////////////////////////////////////////////////////////////
      std::shared_ptr<dtGame::GameActorProxy> ViewerMessageProcessor::ProcessRemoteCreateActor(const dtGame::ActorUpdateMessage& msg)
      {
         std::shared_ptr<dtGame::GameActorProxy> ap = dtGame::DefaultMessageProcessor::ProcessRemoteCreateActor(msg);
      ...
      void ViewerMessageProcessor::UpdateSyncTime(const SimCore::TimeValueMessage& tvMsg)
      {
         ...
         {
            // Send our own query.
            std::shared_ptr<TimeQueryMessage> query;
      ...
      void ViewerMessageProcessor::ProcessPlayerEnteredWorldMessage(const dtGame::Message& msg)
      {
         ...
         {
            std::shared_ptr<dtGame::GameActorProxy> proxy = GetGameManager()->FindGameActorById(msg.GetAboutActorId());
