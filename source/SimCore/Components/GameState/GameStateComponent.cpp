...
namespace SimCore
{
   namespace Components
   {
      ...
      GameStateComponent::GameStateComponent(dtCore::SystemComponentType& type)
         ...
         , mCurrentState(NULL)
      {
         // Makes the naming system work still.
      ...
      void GameStateComponent::ProcessMessage(const dtGame::Message &message)
      {
         ...
         {
            ProcessStateChange( static_cast<const GameStateChangedMessage&>(message) );
         }
      }

      //////////////////////////////////////////////////////////////////////////
      void GameStateComponent::ProcessStateChange( const GameStateChangedMessage& stateChange )
      {
