...
// PLUGIN CODE
////////////////////////////////////////////////////////////////////////////////
RangeRadialPlugin::RangeRadialPlugin( QObject* parent )
   : SimCoreWidgetsPlugin("RangeRadial",parent)
{
   setToolTip("");
   setWhatsThis("");
}
...
////////////////////////////////////////////////////////////////////////////////
QWidget* RangeRadialPlugin::createWidget( QWidget* parent )
{
   RangeRadial* newWidget = new RangeRadial( parent );
   newWidget->onCreated();
   return newWidget;
}
*/