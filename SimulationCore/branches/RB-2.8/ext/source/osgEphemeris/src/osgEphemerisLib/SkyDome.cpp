...
void SkyDome::_buildStateSet()
{
    ...
    // Turn off the depth test when rendering the sky dome.  It should render
    // on top of everything, especially since the previous lines mean that
    // it is being added to whatever is in the frame buffer, like the starts,
