...
namespace NetDemo
{
   ...
   std::shared_ptr<dtDAL::ActorType> NetDemoActorRegistry::HOVER_VEHICLE_ACTOR_TYPE(
   ...
   std::shared_ptr<dtDAL::ActorType> NetDemoActorRegistry::PLAYER_STATUS_ACTOR_TYPE(
   ...
   std::shared_ptr<dtDAL::ActorType> NetDemoActorRegistry::SERVER_GAME_STATUS_ACTOR_TYPE(
      new dtDAL::ActorType("ServerGameStatusActor", "NetDemo", "Status of the overall game - controlled by the server. "));

   std::shared_ptr<dtDAL::ActorType> NetDemoActorRegistry::PROPELLED_VEHICLE_ACTOR_TYPE(
   ...
   std::shared_ptr<dtDAL::ActorType> NetDemoActorRegistry::TOWER_ACTOR_TYPE(
      new dtDAL::ActorType("Tower Actor", "NetDemo", "A generic tower with a turret, used for defense.",
      SimCore::Actors::EntityActorRegistry::MILITARY_GROUND_PLATFORM_ACTOR_TYPE.get()));

   std::shared_ptr<dtDAL::ActorType> NetDemoActorRegistry::FORT_ACTOR_TYPE(
      new dtDAL::ActorType("FortActor", "NetDemo", "The team base - when destroyed the team looses.",
      SimCore::Actors::EntityActorRegistry::MILITARY_GROUND_PLATFORM_ACTOR_TYPE.get()));

   std::shared_ptr<dtDAL::ActorType> NetDemoActorRegistry::ENEMY_MINE_ACTOR_TYPE(
