...
namespace SimCore
{
   ...
   namespace Actors
   {
      ...
      const int WaterGridActor::MAX_TEXTURE_WAVES(16);
      ...
      ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      void WaterGridActor::TickLocal(const dtGame::Message& tickMessage)
      {
         float dt = float(static_cast<const dtGame::TickMessage&>(tickMessage).GetDeltaSimTime());
         Update(dt);
      }
      ...
      void WaterGridActor::Init(const dtGame::Message&)
      {
         ...
         float waveDirArray[] = {10.33, 3.07, 7.0, 10.246,
            33.0, 6.71, -104.0, 5.15,
            -15.5, -21.0, 49.0, 11.0,
            -9.0, -8.0, 16.113, 26.0};

         float waveLengthArray[] = {0.1788, 0.0535, 0.12186, 0.24,
            0.14, 0.116844, 0.97437, 0.0805,
            0.067, 0.3565, 0.67135 , 0.191,
            0.155, 0.13917, 0.275, .448};

         float waveSpeedArray[] = {0.0953, 0.03839, 0.0311, 0.04221,
      ...
      {      
         ...
         for(int count = 0;count < MAX_TEXTURE_WAVES; ++count)
         {
            if(tw_iter != tw_endIter)
            {
               ...
               textureWaveArray->setElement(count, osg::Vec4(wave.mWaveLength, wave.mSpeed, wave.mDirection, freq));
