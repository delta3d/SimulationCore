...
#ifndef WHEELEDVEHICLEACTOR_H_
#define WHEELEDVEHICLEACTOR_H_
...
namespace NetDemo
{
   ...
   class WheeledVehicleActor : public SimCore::Actors::BasePhysicsVehicleActor
   {
   public:
   ...
   protected:
      virtual ~WheeledVehicleActorProxy();
   };

}

#endif /* WHEELEDVEHICLEACTOR_H_ */
