...
namespace Sphero
{
   class SPHERO_EXPORT SpheroInputComponent : public SimCore::Components::BaseInputComponent
   {
      public:
         typedef SimCore::Components::BaseInputComponent BaseClass;
         
         /// Constructor
         SpheroInputComponent(const std::string& name = SimCore::Components::BaseInputComponent::DEFAULT_NAME);
